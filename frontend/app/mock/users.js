...
// Create mock users object with the demo-user-id key
const mockUsers = {
    "demo-user-id": mockUserData
};

// Create properly structured mockSession that NextAuth expects
export const mockSession = {
    user: {
        id: "demo-user-id",
        email: mockUserData.email,
        name: `${mockUserData.firstName} ${mockUserData.lastName}`,
        subscribed: mockUserData.subscribed,
        onTrial: mockUserData.onTrial
    }
};
